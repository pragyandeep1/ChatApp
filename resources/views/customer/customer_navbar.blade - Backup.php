...
<nav class="navbar navbar-expand-lg navbar-light bg-yellow">
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}"><img
                src="{{ asset('customer-images/Logo_white.png') }}"></a>
                    ...
                    <span class="input-group-prepend">
                        <div class="input-group-text border-right-0 drydr" style="background: #ffcc04"><i class="material-icons">room</i></div>
                    </span>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto" id="mobilemenu" style="display: none;">
          <li class="nav-item active">
            <a class="nav-link js-scroll-trigger mx-auto" href="{{ url('/advertise-with-us')}}">Advertise with us </a>
          </li>
          <li class="nav-item active">
            <a class="nav-link js-scroll-trigger mx-auto" href="{{ url('/free-listing')}}"> Free Listing </a>
          </li>

          @if(!Auth::check())
          <li class="nav-item active mx-2">
            <a class="nav-link js-scroll-trigger" href="{{ url('/customer-register')}}">Get App 
              <img src="{{ asset('customer-images/android.svg') }}" id="app">
              <img src="{{ asset('customer-images/apple.svg') }}" id="app">
            </a>
          </li>
          <li class="nav-item active">
            <input type="button" name="signup" class="nav-link js-scroll-trigger text-light bg-blue font-weight-bold" id="navbtn" value="Sign In" onclick="window.location.href='{{ url('/userlogin')}}'">
          </li>
          @endif
        </ul>
      </div>
