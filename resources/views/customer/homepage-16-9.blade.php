        ...
        <div class="slider-wrapper mt-5" id="slider-wrapper">
            ...
            <div class="my-slider">
                ...
                <div>
                    <div class="slide">
                        <div class="slide-img img-3">
                            <img src="{{ asset('customer-images/contractor.svg') }}" class="svg original" alt="sample icon">
                            <img src="{{ asset('customer-images/contractor-hover.png') }}" class="svg hover" alt="sample icon">
                        </div>
                    </div>
                </div>
                <!-- <br> -->
    ...
    <div class="swiper-slide">
      <div class="image-content">
        <div class="card-image">
          <img src="{{ asset('customer-images/rectangle1.png') }}" alt="" class="card-img">
          <h2 class="name">B2B Business Service</h2>
        </div>
      </div>
    </div>
<div class="swiper-slide">
      <div class="image-content">
        <div class="card-image">
          <img src="{{ asset('customer-images/rectangle2.png') }}" alt="" class="card-img">
          <h2 class="name">Lawyer</h2>
        </div>
      </div>
    </div>
    <div class="swiper-slide">
      <div class="image-content">
        <div class="card-image">
          <img src="{{ asset('customer-images/rectangle3.png') }}" alt="" class="card-img">
          <h2 class="name">Charted Accountant</h2>
        </div>
      </div>
    </div>
    <div class="swiper-slide">
    ...
    <div class="swiper-slide">
      <div class="image-content">
        <div class="card-image">
          <img src="{{ asset('customer-images/rectangle2.png') }}" alt="" class="card-img">
          <h2 class="name">Packer and Movers</h2>
        </div>
      </div>
    </div>
    <div class="swiper-slide">
      <div class="image-content">
        <div class="card-image">
          <img src="{{ asset('customer-images/rectangle3.png') }}" alt="" class="card-img">
          <h2 class="name">Electronic Services</h2>
        </div>
      </div>
    </div>
</div>
             <div class="swiper-button-next">
    <img src="{{ asset('customer-images/Arrow-Left.svg') }}" class="swiper-navBtn">
  </div>
  <div class="swiper-button-prev">
    <img src="{{ asset('customer-images/Arrow-Right.svg') }}" class="swiper-navBtn">
  </div>
</div> -->

                    <img src="{{ asset('customer-images/office-meeting.png') }}"
