        ...
        <div class="slider-wrapper mt-5" id="slider-wrapper">
            ...
            <div class="my-slider">
                    ...
                    <div class="slide">
                        <div class="slide-img img-1">
                            <div class="svg-container" id="img-1">
                                ...
                                <img src="{{ asset('customer-images/hotel-hover.svg') }}" class="svg hover" alt="sample icon">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="slide">
                        <div class="slide-img img-1">
                            <img src="{{ asset('customer-images/pg_hostel.svg') }}" class="svg original" alt="sample icon">
                        </div>
                    </div>
                </div>
                <!-- <br> -->
...
<script>
    // JavaScript (optional) - You can use this to handle any additional interactivity
    // For example, if you want to add a click event to the icons
