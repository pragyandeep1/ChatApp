...
<body>
    ...
    <div class="ads_space text-center">
        <img width="100%" src="{{ asset('uploads/userdata/'.$ads->image) }}" alt="image">
    ...
    <div class="container-custom">
                ...
                <div class="product_and_service_filter_box">
                    ...
                    <div class="filter_box_dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item dropdown-rating" href="#" data-rating="1">1 star</a>
                            <a class="dropdown-item dropdown-rating" href="#" data-rating="2">2 star</a>
                            <a class="dropdown-item dropdown-rating" href="#"  data-rating="3">3 star</a>
                            <a class="dropdown-item dropdown-rating" href="#" data-rating="4">4 star</a>
                            <a class="dropdown-item dropdown-rating" href="#" data-rating="5">5 star</a>
        ...
        <div class="container">
          @if(Session::has('error_message'))
              ...
              <script>
                  // Automatically close the alert message after 5 seconds (5000 milliseconds)
                  setTimeout(function() {
                      $('.alert').alert('close');
                  }, 5000);
              </script>
                            ...
                            <div class="result_box_content_title_section">
                                <div class="result_box_content_title">
                                    <div class="result_box_content_title_span row">
                                        ...
                                        <div class="icon_whislist col-2">
                                            ...
                                            @if(Auth::check())
                                            @php 
                                              $countwishlist = App\Models\Likedservice::countWishlist($seller_info->id);
                                            @endphp
                                              <a class="btn btn-outline-primary font_600 like-button updatewishlist" href="#"
                                                  role="button" data-service-id="{{ $seller_info->id }}"
                                                  data-user-id="{{ Auth::user()->id ?? 0 }}">
                                                  <i class="@if($countwishlist > 0) fa fa-heart @else fa fa-heart-o @endif"></i>
                                              </a>
                                            @else
                                              <a class="btn btn-outline-primary font_600 like-button userlogin" href="#"
                                                    role="button" >
                                ...
                                <div class="query_button_section">
                                    <div class="query_button_section_button">
                                        ...
                                        <!-- </button> -->
                                        <a class="btn btn-success font_600" href="#" role="button" data-toggle="modal" data-target="#callbackModal{{ $seller_info->id }}"><i
                                                    class="fa fa-phone"></i> 
                                                    Call me back
                                                    {{-- {{ $seller_info->phone?? 'XXXXXXXXXX' }} --}}
                                            </a>
                                            ...
                                            <!-- The Modal -->
                                            <div class="modal fade" id="callbackModal{{ $seller_info->id }}">
                                        ...
                                        <div class="query_button">
                                          <a class="btn btn-outline-primary" href="#" role="button" data-toggle="modal" data-target="#bestdealmodal{{ $seller_info->id }}">
                                                      Get Best Deal
                                                      {{-- {{ $seller_info->phone?? 'XXXXXXXXXX' }} --}}
                                              </a>
                                              <!-- Best deal modal start -->
                                              <!-- The Modal -->
                                              <div class="modal fade" id="bestdealmodal{{ $seller_info->id }}">
                                                  <div class="modal-dialog modal-dialog-centered modal-lg">
                                                      <div class="modal-content bg-white">

                                                          <!-- Modal Header -->
                                                          <div class="modal-header">
                                                              <h4 class="modal-title">Get Best Deal</h4>
                                                              <button type="button" class="close"
                                                                  data-dismiss="modal">&times;</button>
                                                          </div>
                                                          ...
                                                          <!-- Modal body -->
                                                          <div class="modal-body">
                                                              <form action="{{ url('/save_bestdeal/'.$seller_info->id) }}"
                                                                  method="post">
                                                                  @csrf
                                                                  <input type="hidden" name="best_deal_city" value="" id="best_deal_city">
                                                                  <input type="hidden" name="category_id" value="{{ $seller_info->category_id ?? '' }}">
                                    ...
                                    <div class="result_response">
                                        <div class="time_response"></div>
                                        <div class="enquire_response" data-visit-count="{{ Session::get("seller_service_detail_visits_$seller_info->id", 0) }}" data-seller-id="{{ $seller_info->id }}">
                                          <span>
                                            <i class="fa fa-line-chart"></i>
                                          </span>
                                           {{-- Session::get("seller_service_detail_visits_$seller_info->id", 0) --}}
                                            {{ $seller_info->view }} people recently visited
                                            <!-- enquired -->
                                          </div>
                                    </div>
                                </div>
    ...
    $('#load-more-button').click(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // wishlist variable 
                    var count_wishlists = response.count_wishlists;
                    var is_authenticated = response.is_authenticated;
                    var user_id = response.user_id;
                // wishlist variable  end
                ...
                sellerInfos.forEach(function(sellerInfo) {
                  ...
                  var sessionKey = "seller_service_detail_visits_" + sellerId;
                  // Retrieve the session data using the generated session key
                  var visitCount = sellerInfo.view;
                
                  // var visitCount = $(`[data-visit-count="${sellerInfo.id}"]`).data('visit-count');
                  // var sellerElement = $('[data-seller-id="' + sellerInfo.id + '"]');
                  // sellerElement.find('.visit-count-placeholder').text(visitCount);


                  // count views end
                  var modalId = 'callbackModal-' + sellerInfo.id;
                    var ratingHTML = '';
                    var googleRating = parseFloat(sellerInfo.google_rating);
                    // wishlist start
                    // Calculate wishlist icon and class based on user authentication and wishlist count
                    
                    var wishlistIcon = is_authenticated ?  (count_wishlists[sellerInfo.id] > 0  ? 'fa fa-heart' : 'fa fa-heart-o') : 'fa fa-heart-o';
                    var wishlistClass = is_authenticated ? 'updatewishlist' : 'userlogin';
                    var wishlistUserId = is_authenticated ? user_id : 0;
    ...
    <div class="result_box_content col-lg-9">
      <div class="result_box_content_title_section">
        <div class="result_box_content_title">
          <div class="result_box_content_title_span row">
            ...
            <div class="icon_whislist col-1">
                      <a class="btn btn-outline-primary font_600 like-button  ${wishlistClass}" href="#"
                                    role="button" data-service-id="${ sellerInfo.id }"
                                    data-user-id="${wishlistUserId}">
        ...
        <div class="query_button_section">
          <div class="query_button_section_button">
            <div class="contact_button">
            <a class="btn btn-success font_600" href="#" role="button" data-toggle="modal" data-target="#${modalId}"><i
                                                    class="fa fa-phone"></i> 
                                                    Call me back
                                                    {{-- {{ $seller_info->phone?? 'XXXXXXXXXX' }} --}}
                                            </a>
            ...
            <div class="query_button">
            <a class="btn btn-outline-primary" href="#" role="button" data-toggle="modal" data-target="#bestdealmodal${sellerInfo.id}">
              Get Best Deal</a>
              <!--Best deal  Modal start -->
              <div class="modal fade" id="bestdealmodal${sellerInfo.id}">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content bg-white">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                <form action="{{ url('/save_bestdeal') }}/${sellerInfo.id}"
                    method="post">
                    @csrf
                    <input type="hidden" name="best_deal_city" value="" id="best_deal_city">
                    <input type="hidden" name="category_id" value="${sellerInfo.category_id}">
                    <input type="hidden" name="user_id" value="{{ Auth::user()->id ?? '' }}">
                    <div class="form-row my-3">
                        <div class="col">
                            <input type="text" class="form-control"
...
<!--Best deal  Modal end -->
          ...
          <div class="result_response">
            ...
            <div class="enquire_response">
              <span><i class="fa fa-line-chart"></i></span><span class="visit-count-placeholder">${visitCount}</span> people recently viewed
            </div>
          </div>
        </div>
      </div>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                sellerInfos.forEach(function(sellerInfo) {
                  ...
                  var visitCount = sellerInfo.view; // views count 
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content bg-white">
          ...
          <div class="result_response">
            <div class="time_response"></div>
            <div class="enquire_response">
              <span><i class="fa fa-line-chart">${visitCount} people recently viewed </i></span> 
            </div>
          </div>
        </div>
      </div>
...
<script>
  $(document).on('click', '.updatewishlist', function() {
    ...
    updateWishlist(serviceId, userId); // Call the separate function
});
// Define a function for the AJAX call
function updateWishlist(serviceId, userId) {
    $.ajax({
        type: 'post',
        url: "{{ route('services.updatewishlist') }}",
        ...
        success: function(resp) {
            ...
            if (resp.action == 'add') {
                $('a[data-service-id=' + serviceId + ']').html('<i class="fa fa-heart"></i>');
                Swal.fire({
                    icon: 'success',
                    title: 'Success',
                    text: 'Service added in your wishlist',
                });
            } else if (resp.action == 'remove') {
                $('a[data-service-id=' + serviceId + ']').html('<i class="fa fa-heart-o"></i>');
                Swal.fire({
                    icon: 'success',
                    title: 'Success',
                    text: 'Service removed from your wishlist',
                });
            }
        },
        error: function() {
  ...
  $('.userlogin').click(function(){
    Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'Login to wishlist any service',
            });
  });
  ...
  //     success:function(resp){
  //       if (resp.action == 'add') {
  //          $('a[data-service-id='+service_id+']').html('<i class="fa fa-heart"></i>');
  //          Swal.fire({
  //                   icon: 'success',
  //                   title: 'Success',
  //                   text: 'Service added in your wishlist',
  //               });
  //       } else if(resp.action == 'remove'){
  //         $('a[data-service-id='+service_id+']').html('<i class="fa fa-heart-o"></i>');
  //         Swal.fire({
  //                   icon: 'success',
  //                   title: 'Success',
  //                   text: 'Service removed from your wishlist',
