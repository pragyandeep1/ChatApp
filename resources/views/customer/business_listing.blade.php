...
@section('title') {{'BusinessOdisha'}} @endsection
    ...
    <link rel="stylesheet" href="{{ asset('css/business-listing-style.css') }}">
...
<body>
    ...
    <div class="container-custom">
        <div class="container container bg_white width_limit">
            ...
            <form action="{{ url('/save-businesslisting') }}" method="post" id="userform" name="userform">
                @csrf
...
<script src="{{ asset('js/pages/ecommerce-select2.init.js') }}"></script>
   ...
   $(document).ready(function() {
    ...
    $('#form-service').hide();
        ...
        $('#userform').attr('action', '{{ url('save-businesslisting') }}?visible_div=' + visibleDiv.attr('id'));
