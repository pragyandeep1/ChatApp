...
<div class="footer_section">
        <div class="footer_top_section py-5">
            <div class="container">
                <div id="bar" class="text-light text-uppercase">Back to Top
        ...
        <div class="footer_center_section py-5">
            <div class="container">
                <div class="row footer_center_part_1">
                    ...
                    <div class="col-sm-2">
                        <div class="mail_us">
                            <img src="{{asset('customer-images/chat.svg')}}" style="position: absolute; right: 0; bottom: 0; cursor: pointer;" onclik="window.location.href='{{ url('/userlogin')}}'">
                        </div>
                    </div>
                </div>
            </div>
