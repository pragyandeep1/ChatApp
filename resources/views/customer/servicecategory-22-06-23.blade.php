                ...
                @foreach($seller_infos as $seller_info)
                    ...
                    @else
                        <div class="nodata_found">
                            <img src="{{ asset('customer-images/no-data.jpg') }}" alt="No Data" class="img-fluid">
                            <!-- <p>No data found</p> -->
                        </div>
                    @endif
                     {{-- {!! $seller_infos->render() !!} --}}
...
$(document).ready(function() {
    ...
    var html = '<div class="left_side_box mt-4 row ml-0">';
    html += '<div class="result_box_image col-lg-3">';
    html += '<img src="' + "{{ asset('uploads/userdata/no_image_found-01.jpg') }}" + '">';
    html += '</div>';
    html += '<div class="result_box_content col-lg-9">';
    html += '<div class="result_box_content_title_section">';
    html += '<div class="result_box_content_title">';
    html += '<div class="result_box_content_title_span row">';
    html += '<div class="col">';
    html += '<h1>';
    html += '<span class="icon_thumb">';
    html += '<img src="{{ asset("customer-images/new_thumb_icon.svg") }}">';
    html += '</span>';
    html += '<a href="{{ url("/service-detail") }}/' + sellerInfo.id + '">' + sellerInfo.company_name + '</a>';
    html += '</h1>';
    html += '</div>';
    html += '<div class="icon_whislist col">';
    html += '<img class="float-right" src="{{ asset("customer-images/heart-component.svg") }}">'
    html += '</div>';
    html += '</div>';
    html += '</div>';
    html += '<div class="result_box_rating">';
    html += '<div class="result_box_rating_number">';
    html += '<p>' + sellerInfo.google_rating + '</p>';
    html += '</div>';
    html += '<div class="star_rating"><img src="{{ asset("customer-images/star rating.png") }}"></div>';
    html += '<div class="person_rated">';
    html += '<p>' + sellerInfo.google_rating + ' Rating</p>';
    html += '</div>';
    html += '</div>';
    html += '<div class="result_box_address_section">';
    html += '<div class="result_box_address">';
    html += '<p>' + sellerInfo.full_address + '</p>';
    html += '</div>';
    html += '</div>';
    html += '<div class="result_box_activity_section">';
    html += '<div class="result_box_activity_until">';
    html += '<span class="open">Open</span>';
    html += '<span class="open_until">Until 9 pm</span>';
    html += '</div>';
    html += '<div class="result_dot"></div>';
    html += '<div class="when_in_business">';
    html += '<span> 1 Year in Business</span>';
    html += '</div>';
    html += '</div>';
    html += '<div class="category_button_section">';
    html += '<div class="category_button_part">' + category.name + '</div>';
    html += '</div>';
    html += '<div class="result_box_comment_section">';
    html += '<div class="review_icon"><img src="{{ asset("customer-images/reviewcomment_icon.svg") }}"></div>';
    html += '<div class="comment_text">';
    html += '<p><q>We have booked the Mandap (both floors) for thread ceremony. Excellent experience. Two no AC guest rooms are also spacious. Ample of car parking available. AC was comfort Ample of car parking available. AC was comfort Ample of car parking available. AC was comfort Ample of car parking available.</q></p>';
    html += '</div>';
    html += '</div>';
    html += '<div class="query_button_section">';
    html += '<div class="query_button_section_button">';
    html += '<div class="contact_button">';
    html += '<button type="button" class="btn btn-success"><i class="fa fa-phone"></i> ' + (sellerInfo.phone || 'XXXXXXXXXX') + '</button>';
    html += '</div>';
    html += '<div class="query_button">';
    html += '<button type="button" class="btn btn-outline-primary"> Get Best Deal</button>';
    html += '</div>';
    html += '</div>';
    html += '<div class="result_response">';
    html += '<div class="time_response">Responds in 3 Hours</div>';
    html += '<div class="enquire_response"><span><i class="fa fa-line-chart"></i></span> 67 people recently enquired</div>';
    html += '</div>';
    html += '</div>';
    html += '</div>';
    html += '</div>';
