                ...
                <div class="right_side col-lg-3">
                    ...
                    <div class="right_side_box mt-4">
                        ...
                        <ul class="related_search">
                            <li class="mt-1 first-child-highlight"><a href="{{ url('servicecategory/'.$parent_category->id)}}" class="color777 ">{{$parent_category->name}}</a></li>
                            @foreach($subcategories as $sub_cat_name)
                            <li class="mt-1"><a href="{{ url('/servicecategory/subcat/'.$sub_cat_name->id)}}" class="color777">{{ $sub_cat_name->name }}</a></li>
                            @endforeach
                        </ul>
                    </div>
        ...
        <div class="query_button_section">
          ...
          <div class="result_response">
            ...
            <div class="enquire_response">
              <span><i class="fa fa-line-chart"></i></span> ${visitCount} people recently inquired
            </div>
          </div>
        </div>
      </div>
