                            ...
                            <div class="auth-content my-auto">
                                ...
                                @csrf
                                    <div class="form-floating form-floating-custom mb-4">
                                        <input type="text" class="form-control" id="email" name="email" value="" placeholder="Enter User Name">
                                ...
                                <div class="mb-3">
                                        ...
                                        <div class="mt-3">
                                            <h2 style="font-size: 15px;">Not yet Registered, <span style=""><a href="#">Signup Here</a></span></h2>
                                        </div>
                                    </div>
