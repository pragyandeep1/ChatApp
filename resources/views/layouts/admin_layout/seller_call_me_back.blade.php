                                ...
                                <div class="card-body">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <a href="{{ url('seller-call-me-back-history/') }}"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if($data->history_status == 0)
                                                            <form
                                                                action="{{ url('seller-call-me-back-update', ['id' => $data->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                <input type="hidden" name="service_status">
                                                                <button type="submit"
                                                                    class="btn btn-info waves-effect waves-light btn-xs">Done</button>
                                                            </form>
                                                            @endif

                                                            <!-- <form action="{{ url('call-me-back-delete/'.$data->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
