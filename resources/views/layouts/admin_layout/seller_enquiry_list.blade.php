                                    ...
                                    <table class="table align-middle table-nowrap table-check">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="align-middle">Business no</th>
                                                <th class="align-middle">GST no</th>
                                        ...
                                        <tbody>
                                            @if($count > 0)
                                        @foreach ($seller_enquiry_details as $data)
                                            <tr>
