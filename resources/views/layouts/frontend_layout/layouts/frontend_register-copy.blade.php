        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6 text-black">
                    <div class="d-flex align-items-center h-custom-2 px-5 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                        <form action="{{ url('/save-frontend-seller') }}" method="POST" enctype="multipart/form-data" style="width: 42rem;">
                            @csrf
            ...
            <h4 class="fw-normal mb-3 pb-3 custom_h4">Not a customer, <span class="span_highlights"><a href="{{ url('/customer-register') }}"> Register as a Customer</a></span></h4>
