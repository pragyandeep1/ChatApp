            ...
            <div class="leftside col-md-6">
                ...
                <div class="form_wrapper">
                    <div class="form_header_section">
                        <h2 class="main_form_heading">Register as Seller</h2>
                    ...
                    <form  action="{{ url('/save-frontend-seller') }}" method="POST" enctype="multipart/form-data">
                       @csrf
                            <div class="row mb-2">
                              <div class="col">
                                <label for="company_name">Company Name<span class="star-mark">*</span></label>
                                <input type="text" class="form-control" id="company_name" placeholder="Enter your name" name="company_name" required  oninput="validateInput(this)">
                              </div>
                              <div class="col">
                                <label for="seller_name">Name of Seller<span class="star-mark">*</span></label>
                                <input type="text" class="form-control" id="seller_name" placeholder="Enter  sellername" name="seller_name" required oninput="validateInput(this)">
                              </div>
                            ...
                            <div class="col" style="position: relative;">
                                ...
                                <input required type="tel" class="form-control" placeholder="Enter Phone Number" id="phone" name="phone"  onkeypress="return event.charCode >= 48 && event.charCode <= 57 && this.value.length < 10">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col">
                                  <label for="year_drp_down">Year of Establishment</label>
                                  <input type="date" class="form-control" id="year_drp_down" name="year_drp_down" max="">
                                </div>
                                <div class="col">
                                  <label for="gst_no">GST</label>
                                  <input type="text" class="form-control" placeholder="Enter Your GST" name="gst_no" id="gst_no">
                                </div>
                            ...
                            <div class="row mb-2">
                                <div class="col">
                                  ...
                                  <input type="file" class="form-control" placeholder="Enter image" name="image" id="image">
                                </div>
                                <div class="col">
                    ...
                    <div class="flex items-center justify-end mt-4">
                        <!-- <a href="#" id="google-login-button">
                          <img src="https://developers.google.com/identity/images/btn_google_signin_dark_normal_web.png" style="margin-left: 3em;">
                        </a> -->
                        <a href="{{ route('gmail.login', ['user_type' => 'seller']) }}">
                          <img src="https://developers.google.com/identity/images/btn_google_signin_dark_normal_web.png" style="margin-left: 3em;">
                        </a>
                       
                        <a class="ml-1 btn btn-primary" href="{{ route('facebook.login',['type' => 'seller']) }}" style="margin-top: 0px !important;background: blue;color: #ffffff;padding: 5px;border-radius:7px;" id="btn-fblogin">
                        <!-- <a class="ml-1 btn btn-primary" href="{{ route('facebook.login') }}?type=seller }}" style="margin-top: 0px !important;background: blue;color: #ffffff;padding: 5px;border-radius:7px;" id="btn-fblogin"> -->
                       
                            <i class="fa fa-facebook-square" aria-hidden="true"></i> Login with Facebook
                      </a>
                      </div>
                        <h3>Not a Seller, <span class="highlight_text"><a href="{{url('/customer-register')}}">Register as a Customer</a></span></h3>
                    </div>
                </div>
                <div class="footer">
                    <div class="row">
...
const yearDropdown = document.getElementById("year_drp_down");

// Get the current date in the format yyyy-MM-dd
const today = new Date().toISOString().split("T")[0];

// Set the max attribute of the input field to today's date
yearDropdown.setAttribute("max", today);
