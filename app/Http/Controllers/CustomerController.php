...
class CustomerController extends Controller
{
    public function home(){
     ...
     public function business_listing(){
        $cities = City::get();
        return view('customer.business_listing',compact('cities')); 
     }
     public function save_advertising(Request $request){
        $data = $request->all();
        $business_listing_data = new Advertise_with_us();
        $business_listing_data->companyName = $data['companyName'];
                $business_listing_data->city = $data['city'];
                $business_listing_data->nameprefix = $data['nameprefix'];
                $business_listing_data->lastName = $data['lastName'];
                $business_listing_data->mobileNumber = $data['mobileNumber'];
                $business_listing_data->landlineNumber = $data['landlineNumber']??'';
                $business_listing_data->save();
...
// Recent query used end 
    ...
    public function save_freelisting(Request $request){
        ...
        if ($visibleDivId === 'form-product') {
            ...
            $productdata->save();
            $seller->save();
            return redirect('/business-listing')->with('success', 'Data added successfully');
